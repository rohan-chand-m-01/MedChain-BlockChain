                        ...
                        {!record.encryption_key && (
                            <div className="mb-4 space-y-3">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg transition-colors w-full justify-center border border-blue-200"
                                >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                                    </svg>
                                    <span className="font-medium">Lost Access? Recover Here</span>
                                </button>
                            </div>
                        )}
                ...
                <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white">
                        <div className="flex justify-between items-start">
                            <div>
                                <h2 className="text-2xl font-bold mb-2">🔐 Recover Your Access</h2>
                                <p className="text-blue-100 text-sm">Get back into your encrypted medical reports</p>
                            </div>
                            <button onClick={() => setShowRecoveryModal(false)} className="text-white hover:text-gray-200 text-2xl">×</button>
                        </div>
                    </div>
                    <div className="p-6 space-y-4">
                        <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                            <p className="text-sm text-green-800"><strong>Good News!</strong> Your encrypted reports are safe and recoverable.</p>
                        </div>
                        <div className="space-y-3">
                            <div className="flex gap-3">
                                <div className="w-8 h-8 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center font-bold">1</div>
                                <div><p className="font-medium">Login with the same method</p><p className="text-sm text-gray-600">Use Google, email, etc.</p></div>
                            </div>
                            <div className="flex gap-3">
                                <div className="w-8 h-8 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center font-bold">2</div>
                                <div><p className="font-medium">Privy recovers your wallet</p><p className="text-sm text-gray-600">Keys automatically restored</p></div>
                            </div>
                            <div className="flex gap-3">
                                <div className="w-8 h-8 bg-green-100 text-green-700 rounded-full flex items-center justify-center font-bold">✓</div>
                                <div><p className="font-medium">Access restored!</p></div>
                            </div>
                        </div>
                        <button onClick={() => { setShowRecoveryModal(false); login(); }} className="w-full px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold">
